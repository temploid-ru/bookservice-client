...
var SessionAdminResolver = /** @class */ (function () {
    function SessionAdminResolver(localStorage, sessionS, router) {
        this.localStorage = localStorage;
        this.sessionS = sessionS;
        this.router = router;
    }
    SessionAdminResolver.prototype.resolve = function (route, state) {
        var _this = this;
        ...
        return this.sessionS.login()
            ...
            if (!res.is_admin) {
                _this.router.navigateByUrl('/admin/auth');
            }
        }));
    };
    SessionAdminResolver.ctorParameters = function () { return [
...
var RestaurantRouting = /** @class */ (function () {
    function RestaurantRouting() {
    }
