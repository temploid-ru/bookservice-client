...
var ClientRouting = /** @class */ (function () {
...
var PageClientConfirmComponent = /** @class */ (function () {
    function PageClientConfirmComponent(reservationS, sessionStore, router) {
        this.reservationS = reservationS;
        this.sessionStore = sessionStore;
        this.router = router;
    }
    PageClientConfirmComponent.prototype.ngOnInit = function () {
        var reservationSession = this.sessionStore.retrieve('client:reservation:form');
    ...
    PageClientConfirmComponent.prototype.makeReservation = function () {
        this.reservationS.makeReservation({
            ...
            client: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.reservation.client)
        }).pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_5__["untilDestroyed"])(this))
            .subscribe(console.log);
    };
    PageClientConfirmComponent.prototype.ngOnDestroy = function () {
    };
    PageClientConfirmComponent.ctorParameters = function () { return [
    ...
    return PageClientConfirmComponent;
}());
...
var PageClientContactsComponent = /** @class */ (function () {
    function PageClientContactsComponent(_fb, _router, _sessionStorage) {
        this._fb = _fb;
    ...
    PageClientContactsComponent.prototype.ngOnInit = function () {
        var sessionForm = this._sessionStorage.retrieve('client:reservation:form');
    ...
    PageClientContactsComponent.prototype.submit = function (e) {
        e.preventDefault();
        if (this.form.invalid) {
            return;
        }
        this._sessionStorage.store('client:reservation:form', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this._sessionStorage.retrieve('client:reservation:form'), this.form.value));
        this._router.navigateByUrl('/confirm');
    };
    PageClientContactsComponent.ctorParameters = function () { return [
    ...
    return PageClientContactsComponent;
}());
...
var PageClientReservationComponent = /** @class */ (function () {
    function PageClientReservationComponent(fb, router, momentHelper, reservationS, sessionStorage) {
        this.fb = fb;
        this.router = router;
        ...
        this.tables$ = this.reservationS.tables$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (items) { return items.filter(function (item) { return item.status !== _interfaces_restaurant_table_interface__WEBPACK_IMPORTED_MODULE_9__["RestaurantTableStatusEnum"].BLOCKED; }); }));
    }
    PageClientReservationComponent.prototype.ngOnInit = function () {
        var _this = this;
        var sessionForm = this.sessionStorage.retrieve('client:reservation:form');
    ...
    PageClientReservationComponent.prototype.getTables = function () {
        var timecode = moment__WEBPACK_IMPORTED_MODULE_3__(this.form.value.date.value).format('YYYY-MM-DD');
    ...
    PageClientReservationComponent.prototype.getDays = function () {
        var _this = this;
    ...
    PageClientReservationComponent.prototype.submit = function (e) {
        e.preventDefault();
        if (this.form.invalid) {
            return;
        }
        this.sessionStorage.store('client:reservation:form', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.sessionStorage.retrieve('client:reservation:form'), this.form.value));
        this.router.navigateByUrl('/contacts');
    };
    PageClientReservationComponent.prototype.ngAfterViewInit = function () {
    };
    PageClientReservationComponent.prototype.ngOnDestroy = function () {
    };
    PageClientReservationComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    ...
    return PageClientReservationComponent;
}());
...
var PageClientTotalComponent = /** @class */ (function () {
    function PageClientTotalComponent(reservationS, activatedRoute) {
        this.reservationS = reservationS;
        this.activatedRoute = activatedRoute;
        this.type = 'SMS';
    }
    PageClientTotalComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PageClientTotalComponent.prototype.ngOnDestroy = function () {
    };
    PageClientTotalComponent.ctorParameters = function () { return [
        { type: _app_services_reservation_reservation_service__WEBPACK_IMPORTED_MODULE_2__["ReservationService"] },
    ...
    return PageClientTotalComponent;
}());
...
var ReservationDepositComponent = /** @class */ (function () {
    function ReservationDepositComponent() {
        this.amount = 250;
    }
    ReservationDepositComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    ...
    return ReservationDepositComponent;
}());
...
var ReservationDepositModule = /** @class */ (function () {
    function ReservationDepositModule() {
    }
    ...
    return ReservationDepositModule;
}());
...
var ReservationInfoComponent = /** @class */ (function () {
    function ReservationInfoComponent() {
        this.isTotal = false;
        this.amount = 250;
    }
    ReservationInfoComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
...
var ReservationInfoModule = /** @class */ (function () {
...
var ClientHeaderComponent = /** @class */ (function () {
    function ClientHeaderComponent(_location) {
        this._location = _location;
    }
    ClientHeaderComponent.prototype.ngOnInit = function () {
    };
    ClientHeaderComponent.prototype.goBack = function (e) {
        e.preventDefault();
        this._location.back();
    };
    ClientHeaderComponent.ctorParameters = function () { return [
...
var ClientHeaderModule = /** @class */ (function () {
    function ClientHeaderModule() {
    }
