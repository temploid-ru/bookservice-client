...
/***/ "./node_modules/@w11k/angular-sticky-things/fesm5/w11k-angular-sticky-things.js":
/*!**************************************************************************************!*\
  !*** ./node_modules/@w11k/angular-sticky-things/fesm5/w11k-angular-sticky-things.js ***!
  \**************************************************************************************/
...
var StickyThingDirective = /** @class */ (function () {
    function StickyThingDirective(stickyElement, platformId) {
        ...
        this.status$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(this.enable$, this.scrollThrottled$, this.marginTop$, this.marginBottom$, this.extraordinaryChange$, this.resizeThrottled$)
            ...
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 1), enabled = _b[0];
            return _this.checkEnabled(enabled);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (_a) {
            var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__read"])(_a, 4), enabled = _b[0], pageYOffset = _b[1], marginTop = _b[2], marginBottom = _b[3];
     ...
     * @return {?}
     */
    StickyThingDirective.prototype.removeListener = /**
     * @return {?}
     */
    function () {
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["isPlatformBrowser"])(this.platformId)) {
    ...
    StickyThingDirective.propDecorators = {
        scrollContainer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        marginTop: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        marginBottom: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        enable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        spacerElement: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['spacer',] }],
        boundaryElement: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['boundary',] }],
        sticky: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"], args: ['class.is-sticky',] }],
        boundaryReached: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"], args: ['class.boundary-reached',] }],
...
var TimeHelper = /** @class */ (function () {
    ...
    TimeHelper.prototype.getTimeFromMinutes = function (minutes) {
...
var BookAddComponent = /** @class */ (function () {
    function BookAddComponent(router) {
        this.router = router;
    }
    BookAddComponent.prototype.ngOnInit = function () {
    };
    BookAddComponent.prototype.onSuccess = function () {
...
var BookDetailsComponent = /** @class */ (function () {
    function BookDetailsComponent(_activatedRoute, _reservationS) {
    ...
    BookDetailsComponent.prototype.ngOnInit = function () {
        ...
        this._reservationS.getReservationDetails(this._activatedRoute.snapshot.params.id)
            ...
            .subscribe(function (res) { return _this.reservation = res.result; });
    };
    BookDetailsComponent.prototype.ngOnDestroy = function () {
    };
    BookDetailsComponent.ctorParameters = function () { return [
...
var BookEditComponent = /** @class */ (function () {
    function BookEditComponent(_reservationS, _activatedRoute, router) {
        this._reservationS = _reservationS;
        this._activatedRoute = _activatedRoute;
        this.router = router;
    }
    BookEditComponent.prototype.ngOnInit = function () {
        ...
        this._reservationS.getReservationDetails(this._activatedRoute.snapshot.params.id)
            ...
            _this.reservation = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, res.result);
        });
    };
    BookEditComponent.prototype.ngOnDestroy = function () {
    };
    BookEditComponent.prototype.onSuccess = function () {
        this.router.navigateByUrl('/admin');
    };
...
var BookFormComponent = /** @class */ (function () {
    function BookFormComponent(fb, reservationS, momentHelper) {
        this.fb = fb;
    ...
    BookFormComponent.prototype.getReservationTime = function (data) {
        var _this = this;
        this.reservationS
            ...
            _this.timeOptions = time.items;
            _this.getTables();
        });
    };
    BookFormComponent.prototype.formSubscriptions = function () {
        var _this = this;
        ...
        this.form.controls
            ...
            _this.form.controls.table[!e ? 'disable' : 'enable']();
            setTimeout(function () { return _this.getTables(); }, 0);
        });
        this.form.controls
            .guests
            .valueChanges
    ...
    BookFormComponent.prototype.initCreateForm = function () {
    ...
    BookFormComponent.prototype.initEditForm = function () {
        this.form = this.fb.group({
            ...
            table: [tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ deposit: this.reservation.deposit }, this.reservation.table), [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
    ...
    BookFormComponent.prototype.getTables = function () {
        var timecode = moment__WEBPACK_IMPORTED_MODULE_4__(this.form.value.date.value).format('YYYY-MM-DD');
        if (this.form.value.time) {
            timecode = this.form.value.time.value;
        }
        this.reservationS.getReservationTables({ timecode: timecode, num_guests: this.form.value.guests })
            .pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this))
            .subscribe();
    };
    BookFormComponent.prototype.getDays = function () {
        var _this = this;
        this.reservationS.getReservationDays(this.queryDaysMonth.format('YYYY-MM'))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this))
            .subscribe(function (days) {
            _this.days = _this.momentHelper.cutFromToday(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.days, days.items), _this.daysLength);
            if (_this.type === 'CREATE') {
                _this.form.patchValue({ date: _this.days[0] });
            }
            if (_this.days.length < _this.daysLength) {
                _this.queryDaysMonth.add(1, 'months');
                _this.getDays();
            }
        });
    };
    BookFormComponent.prototype.submit = function (e) {
        var _this = this;
        e.preventDefault();
        if (!this.form.valid) {
            return;
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(_matDialog, _reservationS, _fb, _router) {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.form.controls.date.valueChanges
            ...
            _this.getReservationTime(date);
            _this.getTables(date);
        });
    };
    DashboardComponent.prototype.getTables = function (date) {
    ...
    DashboardComponent.prototype.getReservationTime = function (date) {
        var _this = this;
        this._reservationS.getReservationTime(moment__WEBPACK_IMPORTED_MODULE_4__(date || this.form.value.date).format('YYYY-MM-DD'))
            .pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_5__["untilDestroyed"])(this))
            .subscribe(function (items) { return _this.timelineHeaderItems = items.items.filter(function (item) { return item.title.indexOf(':00') !== -1; }); });
    };
    DashboardComponent.prototype.onTableSelect = function (reservation) {
        this._router.navigateByUrl('/admin/edit/' + reservation.id);
    };
    DashboardComponent.prototype.changePickerDay = function (state) {
...
var GanttTimelineChartComponent = /** @class */ (function () {
    function GanttTimelineChartComponent(_tableS, _tableQ, _reservationS, _timeHelper, _elRef) {
    ...
    GanttTimelineChartComponent.prototype.onResize = function () {
        var _this = this;
    ...
    GanttTimelineChartComponent.prototype.ngOnInit = function () {
        this.gridSteps = this.timelineHeaderItems.length;
        // this.tables = tables || [];
    };
    GanttTimelineChartComponent.prototype.init = function () {
    ...
    GanttTimelineChartComponent.prototype.drawGrid = function () {
        var gridLayer = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Layer();
        for (var i = 0; i < (this.gridSteps); i++) {
            var verticalLine = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Line(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ preventDefault: false, points: [i * this.gridWidth + this.gridWidth, 0, i * this.gridWidth + this.gridWidth, this.stage.height()] }, this.lineStyle));
            var verticalLineHalf = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Line(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ preventDefault: false, points: [i * this.gridWidth + this.gridWidth / 2, this.gridHeight, i * this.gridWidth + this.gridWidth / 2, this.stage.height()] }, this.lineStyle));
            var halfBgRect = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Rect({
            ...
            var timeTitle = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Text({
                preventDefault: false,
        ...
        for (var z = 0; z < this.tables.length + 1; z++) {
            if (z === 0) {
                continue;
            }
            var horizontalLine = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Line(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ preventDefault: false, points: [0, z * this.gridHeight, this.stage.width(), z * this.gridHeight] }, this.lineStyle));
            gridLayer.add(horizontalLine);
        }
        this.stage.add(gridLayer);
    };
    GanttTimelineChartComponent.prototype.drawTables = function () {
        var _this = this;
        var tableLayer = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Layer();
        this.tables.forEach(function (table, i) {
            var tableText = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Text({
                preventDefault: false,
                text: table.number.toString(),
                x: _this.gridWidth / 2,
                y: _this.gridHeight / 2 + _this.gridHeight * i + _this.gridHeight
            });
            tableText.offset({
                x: tableText.width() / 2,
                y: tableText.height() / 2
            });
            var tableBackground = new konva__WEBPACK_IMPORTED_MODULE_2___default.a.Circle({
                preventDefault: false,
                radius: Math.min(_this.gridWidth, _this.gridHeight) * 0.8 / 2,
                x: _this.gridWidth / 2,
                y: _this.gridHeight / 2 + _this.gridHeight + _this.gridHeight * i,
                fill: '#eee'
            });
    ...
    GanttTimelineChartComponent.prototype.onScroll = function (e) {
        this.stickyLeft = -e.target.scrollLeft + this.containerPadding;
    };
    GanttTimelineChartComponent.prototype.ngOnChanges = function (e) {
    ...
    GanttTimelineChartComponent.prototype.ngOnDestroy = function () {
    };
    GanttTimelineChartComponent.ctorParameters = function () { return [
    ...
    return GanttTimelineChartComponent;
}());
...
/* harmony import */ var _w11k_angular_sticky_things__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @w11k/angular-sticky-things */ "./node_modules/@w11k/angular-sticky-things/fesm5/w11k-angular-sticky-things.js");
...
var GanttTimelineChartModule = /** @class */ (function () {
    function GanttTimelineChartModule() {
    }
    ...
    return GanttTimelineChartModule;
}());
...
var TimelineItemComponent = /** @class */ (function () {
    function TimelineItemComponent(_elRef, _renderer) {
        this._elRef = _elRef;
...
var TimelineTableComponent = /** @class */ (function () {
    function TimelineTableComponent(_elRef) {
        this._elRef = _elRef;
    }
    TimelineTableComponent.prototype.ngOnInit = function () {
    };
    TimelineTableComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
function createAdminRestaurantTable(params) {
    return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, params);
}
...
var AdminRestaurantTablesDataService = /** @class */ (function () {
    function AdminRestaurantTablesDataService(http) {
        this.http = http;
    }
    AdminRestaurantTablesDataService.ctorParameters = function () { return [
    ...
    return AdminRestaurantTablesDataService;
}());
...
var AdminRestaurantTablesQuery = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AdminRestaurantTablesQuery, _super);
    function AdminRestaurantTablesQuery(store) {
        var _this = _super.call(this, store) || this;
        _this.store = store;
        return _this;
    }
    AdminRestaurantTablesQuery.ctorParameters = function () { return [
    ...
    return AdminRestaurantTablesQuery;
...
var AdminRestaurantTablesService = /** @class */ (function () {
    function AdminRestaurantTablesService(adminRestaurantTablesStore, adminRestaurantTablesDataService) {
    ...
    return AdminRestaurantTablesService;
}());
...
var AdminRestaurantTablesStore = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AdminRestaurantTablesStore, _super);
    function AdminRestaurantTablesStore() {
        return _super.call(this) || this;
    }
    ...
    return AdminRestaurantTablesStore;
